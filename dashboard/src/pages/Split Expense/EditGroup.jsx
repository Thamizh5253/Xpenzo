...
const GroupCreationModal = ({ isOpen, onClose, users  ,setGroups , editData , setEditData}) => {
  const [group_name, setGroupName] = useState(editData?.group_name || '');
  const [description, setDescription] = useState(editData?.description || '');
  const [avatarPreview, setAvatarPreview] = useState(editData?.avatar || null);
  const [selectedMembers, setSelectedMembers] = useState(editData?.members || []);
